...
if __name__ == "__main__":
    ...
    parser.add_argument('--gold', dest='gold', default='../data/spider/dev_gold.sql', type=str,
                        help="the path to the gold queries")
    parser.add_argument('--pred', dest='pred', type=str, default='../outputs/spider/output.sql',
